...
<?php
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM tbl_theaters WHERE id=$id";
            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            ...
                            {  
                                ?>
                                <img src="<?php echo SITEURL; ?>images/theaters/<?php echo $current_image; ?>" width="240px">
                                <?php
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update Theater" class="btn-secondary">
                    </td>
                </tr>
            </table>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $dest_path = "../images/theaters/".$image_name;
                        ...
                        if($current_image!="")
                        {
                            $remove_path = "../images/theaters/".$current_image;
